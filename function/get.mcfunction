loot spawn ~ -65 ~ loot id.block:block
execute positioned ~ -65 ~ run data modify storage kch:block id set from entity @n[type=item] Item.components."minecraft:custom_data".block

execute positioned ~ -65 ~ run kill @n[type=item]
